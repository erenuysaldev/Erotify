...
const MusicLibrary: React.FC<MusicLibraryProps> = ({ playlists, onPlaylistsChange }) => {
  ...
  const handleAddToPlaylist = async (playlistId: string, songId: string | null) => {
    ...
    try {
      ...
      console.error('Şarkı playlist\'e eklenirken hata:', error);
      alert('Şarkı playlist\'e eklenirken bir hata oluştu');
    }
  };
    ...
    return (
      <div className="p-6 flex items-center justify-center h-64">
        <div className="text-center">
          ...
          <p className="text-dark-600">Şarkılar yükleniyor...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="p-8">
        <div className="flex items-center justify-center h-64">
          <div className="text-center">
            ...
            <p className="text-dark-600">İlk şarkınızı yüklemek için "Müzik Yükle" sekmesini kullanın</p>
          </div>
        </div>
      </div>
    );
    ...
    <div className="p-6">
      ...
      <div className="space-y-1">
        ...
        <div className="grid grid-cols-12 gap-4 px-4 py-2 text-sm font-medium text-dark-600 border-b border-dark-500">
          ...
          <div className="col-span-2">ALBÜM</div>
        ...
        {songs.map((song, index) => (
          ...
          >
            ...
            <div className="col-span-2 flex items-center">
              <p className="text-sm text-dark-600 truncate">{song.album || 'Bilinmeyen Albüm'}</p>
            </div>
            ...
            <div className="col-span-1 flex items-center justify-end">
              <div className="flex items-center space-x-2 opacity-0 group-hover:opacity-100 transition-opacity">
                <button className="text-dark-600 hover:text-white transition-colors p-1">
                  ...
                  {showDropdown === song.id && (
                    <div className="absolute right-0 mt-2 w-48 bg-dark-300 rounded-md shadow-xl border border-dark-500 z-10">
                      <button
                        ...
                        className="w-full px-4 py-2 text-left text-sm text-white hover:bg-dark-400 flex items-center gap-2 rounded-t-md"
                      >
              ...
              <div className="space-y-2">
                {playlists.map((playlist) => (
                  ...
                  >
                    ...
                    <p className="text-sm text-dark-600">{playlist.songIds.length} şarkı</p>
                  </button>
                ))}
              </div>
            )}
